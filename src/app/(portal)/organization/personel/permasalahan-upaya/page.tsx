...
const tableKey = "personnel-problem-actions";
...
const defaultRows: EditableTableDefaultRow[] = [
  {
    ...
    cells: {
      problem:
        "Belum terawakinya beberapa jabatan prioritas yang diisi dan masih terdapat 16 kekosongan jabatan Perwira Kosek IV dan Satrad Jajaran yang belum terisi.",
      action:
        "Mengoptimalkan Perwira yang ada dan telah diajukan ke Komando atas sesuai surat Dankosek IKN Nomor R/16-08/02/01/Kosek IKN tanggal 7 Maret 2025 dan surat Pangkosek IV Nomor R/89-08/02/01/Kosek IV tanggal 4 November 2025 tentang usulan jabatan kosong prioritas.",
    },
  },
];

export default async function PersonnelProblemActionPage() {
