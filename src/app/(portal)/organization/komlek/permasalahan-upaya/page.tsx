...
const tableKey = "communication-electronics-problem-actions";
...
const defaultRows: EditableTableDefaultRow[] = [
  {
    ...
    cells: {
      problem:
        "Satrad 402 CBL, TMT 6 Februari 2026 terjadi permslahan pada sistem PSR & SSR Radar Thomson TRS 2215-D.",
      action:
        "1. Tanggal Pangkoosek IV NR T/21/2026 tanggal 7 Februari 2026 tentang permohonan dukungan Sucad Radar Satrad 402 CBL.\n\n2. Tanggal Pangkoosek IV NR T/25/2026 tanggal 17 Februari 2026 tentang permohonan dukungan Banharalap.\n\n3. Tanggal Pangkoosek IV NR T/88/2026 tanggal 20 Mei 2026 tentang laporan permohonan dukungan Sucad High Voltage Power Supply TWT PN 16587014 sebanyak 1 unit.",
    },
  },
  {
    rowKey: "row-2",
    cells: {
      problem:
        "Satrad 421 TGA, TMT 7 Juni 2026 terjadi permasalahan pada sistem Radar sehingga tidak dapat Operasional.",
      action:
        "1. Tanggal Dankosek IV NR T/95/2026 tanggal 8 Juni 2026 tentang permohonan dukungan Power Amplifier Module (PAM) PN 13588911.",
    },
  },
];

export default async function CommunicationElectronicsProblemActionPage() {
