...
const vehicleRows: TableCell[][] = [
  ...
  [
    ...
    "-",
    "2",
    "Terbit Kep Hapus Kep/107/IV/2026 tgl 7 Apr 2026",
  ],
  [
    "3",
    "Satrad 402 CBL",
  ...
  [
    ...
    "-",
    "1",
    "Pengajuan Usul Hapus B/108-09/23/01/Kosek IV tgl 27 Feb 2026",
  ],
  [
    { value: "5" },
    { value: "Satrad 404 CGT" },
    { value: "Nihil", colSpan: 8, className: "text-center uppercase" },
    { value: "" },
  ],
  [
    "6",
  ...
  [
    { value: "8" },
    { value: "Satrudal 421 TGA" },
    { value: "Nihil", colSpan: 8, className: "text-center uppercase" },
    { value: "" },
  ],
  [
    { value: "9" },
    { value: "Satrad 106 TPI" },
    { value: "Nihil", colSpan: 8, className: "text-center uppercase" },
    { value: "" },
  ],
  [
    ...
    "1",
    "3",
    "Terbit Kep Hapus Kep/54/II/2026 tgl 12 Feb 2026",
  ],
].map((row) =>
...
const defaultRows: EditableTableDefaultRow[] = vehicleRows.map((row, index) => {
  ...
  const isNilRow = row.some((cell) => cell.value === "Nihil");

  if (isNilRow) {
    for (const key of vehicleColumnKeys.slice(2, 10)) {
      cells[key] = "Nihil";
    }
  }

  return {
    rowKey: `vehicle-${index + 1}`,
    cells,
  };
});
