...
const nil = "Nihil";
const highlightCellClass = "bg-[#dbe8fb] text-[#071a33]";

const moneyGrantRows: TableCell[][] = [
  ["1", nil, nil, "Kosek IV", nil, nil, nil, nil, nil, ""],
  ["2", nil, nil, "Satrad 401 Tkt", nil, nil, nil, nil, nil, ""],
  ["3", nil, nil, "Satrad 201 Rni", nil, nil, nil, nil, nil, ""],
  ["4", nil, nil, "Satrad 106 Tpi", nil, nil, nil, nil, nil, ""],
  ["5", nil, nil, "Satrad 403 Tgl", nil, nil, nil, nil, nil, ""],
  ["6", nil, nil, "Satrad 404 Cgt", nil, nil, nil, nil, nil, ""],
  [
    "7",
    "Pemkab Sukabumi",
    "Hibah Langsung Uang",
    ...
    "Rp100.000.000",
    "ZUBH1KJA 11-08-2025",
    "900.1.13.5/2553/Bakesbangpol/2025 11-09-2025",
    "00375T/344811/2025 4-12-2025",
    "2559990618590001 5-12-2025",
    "",
  ].map((value) => ({ value, className: highlightCellClass })),
  ["8", nil, nil, "Satrudal 421 Tga", nil, nil, nil, nil, nil, ""],
].map((row) =>
  row.map((cell) => (typeof cell === "string" ? { value: cell } : cell)),
);

const goodsGrantRows: TableCell[][] = [
  ["1", nil, nil, "Kosek IV", nil, nil, nil, nil, nil, nil, nil, nil],
  ["2", nil, nil, "Satrad 401 Tkt", nil, nil, nil, nil, nil, nil, nil, nil],
  ["3", nil, nil, "Satrad 402 Cbl", nil, nil, nil, nil, nil, nil, nil, nil],
  [
    "4",
    "Pemerintah Kabupaten Tegal",
    "Hibah langsung berupa barang/jasa berupa lanjutan pembangunan Gedung Serba Guna Satrad dari Pemerintah Kabupaten Tegal",
    "Satrad 403 Tgl",
    "Rp177.430.000",
    "Adm Dalam Proses",
    "BA/07/XII/2025",
  ...
  ["5", nil, nil, "Satrad 404 Cgt", nil, nil, nil, nil, nil, nil, nil, nil, nil],
  ["6", nil, nil, "Satrad 405 Plo", nil, nil, nil, nil, nil, nil, nil, nil, nil],
].map((row) =>
  row.map((cell) => (typeof cell === "string" ? { value: cell } : cell)),
);

const bmpRows: TableCell[][] = [
  [
    { value: "A", className: "bg-[#0b2d66] text-yellow-100" },
    {
      value: "Bahan Bakar",
      className: "bg-[#0b2d66] text-left text-yellow-100",
      colSpan: 2,
    },
    { value: "", colSpan: 10 },
  ],
  ["1", "MT-92/Pertamax", "Liter", "32.000", "-", "-", "-", "-", "-", "2.000", "4.000", "38.000", ""],
  ["2", "MT-88/Pertalite", "Liter", "44.000", "40.000", "20.000", "8.000", "16.000", "16.000", "12.000", "-", "156.000", ""],
  ["3", "HSD/Bio Solar", "Liter", "54.000", "206.000", "364.000", "312.000", "116.000", "208.000", "262.000", "8.000", "1.530.000", ""],
  ["4", "Pertamina Dex", "Liter", "2.000", "-", "-", "-", "-", "-", "-", "164.000", "166.000", ""],
  [
    { value: "B", className: "bg-[#0b2d66] text-yellow-100" },
    {
      value: "Pelumas",
      className: "bg-[#0b2d66] text-left text-yellow-100",
      colSpan: 2,
  ...
  ["1", "Mesran Super", "Liter", "836", "240", "240", "836", "320", "240", "240", "240", "3.192", ""],
  ["2", "Meditran S 40", "Liter", "320", "1.672", "1.672", "836", "836", "836", "1.672", "1.672", "9.516", ""],
  ["3", "Mesran SC", "Liter", "-", "-", "-", "-", "-", "-", "-", "-", "-", ""],
  ["4", "Meditran SX", "Liter", "-", "-", "-", "836", "-", "-", "-", "-", "836", ""],
  ["5", "Aeroshell 5M-A", "Liter", "-", "-", "-", "-", "-", "-", "-", "-", "-", ""],
  ["6", "BG-300", "KG", "-", "-", "-", "-", "-", "-", "-", "-", "-", ""],
].map((row) =>
  row.map((cell) => (typeof cell === "string" ? { value: cell } : cell)),
);
...
function getDefaultRows(section: RecapSection): EditableTableDefaultRow[] {
  return section.rows.map((row, rowIndex) => {
    ...
    return {
      rowKey: `${section.tableKey}-row-${rowIndex + 1}`,
      cells,
    };
  });
}
  ...
  const rowsByTableKey = new Map(
    await Promise.all(
      sections.map(async (section) => [
        section.tableKey,
        await getEditableTableRows(section.tableKey, getDefaultRows(section)),
      ] as const),
    ),
  );
