...
const tableKey = "logistics-problem-actions";
...
const defaultRows: EditableTableDefaultRow[] = [
  {
    ...
    cells: {
      problem:
        "Belum tersedianya Gudang penyimpanan Senjata/Amunisi sehingga penyimpanan Senmu belum optimal.",
      action:
        "Berkoordinasi dengan Sisen Lanud Halim untuk penyimpanan Amunisi alokasi Kosek IV, Satrad 401 TKT dan Satrudal 421 TGA.",
    },
  },
  {
    rowKey: "row-2",
    cells: {
      problem:
        "Kosek IV beserta jajaran belum memiliki perlengkapan PHH yang lengkap guna mendukung kegiatan pengamanan materiel Alutsista dan Non Alutsista.",
      action:
        "Mengajukan surat ke Kotas dengan Nomor B/355/IX/2025 tanggal 4 September 2025 tentang Permohonan Kebutuhan Perlengkapan PHH.",
    },
  },
  {
    rowKey: "row-3",
    cells: {
      problem:
        "Belum adanya kendaraan berupa Bus sedang/Microbus untuk kegiatan operasional personel Kosek IV.",
      action:
        "Mengajukan RKAKL dengan nomor Surat B/105-03/02/04/Kosek IKN tanggal 24 Maret 2025 tentang Rencana Kebutuhan Bangmat Kosek IKN dan Satuan Jajaran.",
    },
  },
];

export default async function LogisticsProblemActionPage() {
