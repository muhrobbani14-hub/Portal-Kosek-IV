...
const simakRows: SimakRow[] = [
  {
    no: "1",
    activity: "Membukukan BMN kedalam DBKP (Daftar Barang Kuasa Pengguna)",
    amount: "12 kali",
    note: "Terjadwal",
  },
  {
    no: "2",
    activity: "Membuat DIR/DIL serta memberikan tanda registrasi BMN",
    amount: "1 kali",
    note: "Terjadwal",
  },
  {
    no: "3",
    activity: "Membuat KIB (Kartu Inventaris Barang)",
    amount: "4 kali",
    note: "Tidak Terjadwal",
  },
  {
    no: "4",
    activity: "Inventarisasi BMN dan menyusun LHI (Laporan Hasil Inventarisasi)",
    amount: "1 kali",
    note: "Terjadwal",
  },
  {
    no: "5",
    activity: "Menyusun LBKP (Laporan Barang Kuasa Pengguna).",
    amount: "4 kali",
    note: "Terjadwal",
  },
  {
    no: "6",
    activity: "Menyusun LBKPS (Laporan Barang Kuasa Pengguna Semester)",
    amount: "2 kali",
    note: "Terjadwal",
  },
  {
    no: "7",
    activity: "Menyusun LBKPT (Laporan Barang Kuasa Pengguna Tahunan)",
    amount: "1 kali",
    note: "Terjadwal",
  },
];

const defaultRows: EditableTableDefaultRow[] = simakRows.map((row) => ({
  rowKey: `simak-${row.no}`,
  cells: {
