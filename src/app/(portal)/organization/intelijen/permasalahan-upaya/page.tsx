...
const tableKey = "intelligence-problem-actions";
...
const defaultRows: EditableTableDefaultRow[] = [
  {
    ...
    cells: {
      problem:
        "Terbatasnya baket untuk pemutakhiran database K3N Negara Asing dari Aspek Matra Udara yang dituangkan dalam ADO.",
      action:
        "Koordinasi dengan Kotas dan satuan lainnya, serta publikasi melalui Osint (Military Balance & Air Power World).",
    },
  },
  {
    rowKey: "row-2",
    cells: {
      problem:
        "Tempat Kegiatan Sandi (TKS) Satrudal 421 TGA belum sesuai Standar TKS.",
      action:
        "Pengajuan surat permohonan ke Kotas: Surat Dankosek IKN No: R/95-06/05/01/Kosek IKN tanggal 27 Desember 2024 tentang Permohonan pembangunan TKS Satrad 213 TPI dan Satrudal 421 TGA.\nSurat Dankosek IKN No: R/09-06/05/01/Kosek IKN tanggal 6 Februari 2025 tentang Data Rencana Anggaran (RAB) alokasi KMR Sandi dan Peralatan Persandian Satrudal 421 TGA.",
    },
  },
];

export default async function IntelligenceProblemActionPage() {
